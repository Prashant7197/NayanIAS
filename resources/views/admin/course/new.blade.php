...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Courses/</span> Add new Course</h4>
                    ...
                    <form method="post" action="/admin/course" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <input type="text" required class="form-control" name="name" id="basic-icon-default-fullname" placeholder="SSC" aria-label="SSC" aria-describedby="basic-icon-default-fullname2" />
                            </div>
                        </div>
                        <div class="mb-3">
